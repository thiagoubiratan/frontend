...
export default function Product({ categoryList }: CategoryProps) {
    ...
    async function handleRegister(e: FormEvent) {
        ...
        try {
            ...
            data.append('category_id', categories[categorySelected].id.toString());
                ...
                <main className={styles.container} onSubmit={handleRegister}>
                    ...
                    <form className={styles.form}>
                        <label className={styles.labelAvatar}>
                            <span>
                                <FiUpload size={25} color='#FFF'></FiUpload>
                            </span>
                        ...
                        <select value={categorySelected} onChange={handlerChangeCategory}>
